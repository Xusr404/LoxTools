...
- GitHub-backed LoxTools update notifications with stable, beta, and alpha channels.
- Optional Authenticode signing and verified installer execution for application updates.
